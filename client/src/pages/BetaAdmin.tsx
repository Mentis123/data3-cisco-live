    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-center">Beta Admin Access</CardTitle>
    ...
    <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold">Beta Admin Dashboard</h1>
            <p className="text-muted-foreground">
              Manage trivia experience and raffle entries
            </p>
          </div>
          <Link href="/beta">
            <Button variant="outline">Back to Beta</Button>
          </Link>
        </div>
