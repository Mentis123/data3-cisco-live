              ...
              >
                <div className="relative aspect-square">
                  ...
                  <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 px-6 text-center">
                    <span className="text-4xl sm:text-5xl font-bold text-data3-white group-active:text-data3-blue-black drop-shadow-lg">Training Dojo</span>
                  </div>
                </div>
              </div>
            </Link>
            <Link href="/play" className="group">
              ...
              >
                <div className="relative aspect-square">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-white/5 to-transparent transition-colors duration-300 group-hover:from-white/15 group-hover:via-white/10 group-hover:to-white/5" />
                  <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 px-6 text-center">
                    <span className="text-4xl sm:text-5xl font-bold text-data3-white group-active:text-data3-blue-black drop-shadow-lg">Enter the Ring</span>
                  </div>
                </div>
              </div>
            </Link>
            <Link href="/how-to-play" className="group">
              ...
              >
                <div className="relative aspect-square">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-white/5 to-transparent transition-colors duration-300 group-hover:from-white/15 group-hover:via-white/10 group-hover:to-white/5" />
                  <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 px-6 text-center">
                    <span className="text-4xl sm:text-5xl font-bold text-data3-white group-active:text-data3-blue-black drop-shadow-lg">How to Play</span>
                  </div>
                </div>
              </div>
            </Link>
            <Link href="/leaderboard" className="group">
              ...
              >
                <div className="relative aspect-square">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-white/5 to-transparent transition-colors duration-300 group-hover:from-white/15 group-hover:via-white/10 group-hover:to-white/5" />
                  <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 px-6 text-center">
                    <span className="text-4xl sm:text-5xl font-bold text-data3-white group-active:text-data3-blue-black drop-shadow-lg">View Leaderboard</span>
                  </div>
                </div>
              </div>
            </Link>
