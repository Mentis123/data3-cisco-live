            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center">
                  <h1 className="text-[1.1rem] sm:text-xl font-semibold leading-tight truncate">Classic Solution Sprint</h1>
                ...
                <p className="text-[0.825rem] sm:text-sm text-muted-foreground hidden sm:block tracking-wide">Data<sup className="text-primary">#</sup>3 | Cisco Live Melbourne (Classic)</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Link href="/">
                <Button variant="default" size="sm" className="min-h-[44px] px-3 sm:px-4" data-testid="button-new-version">
                  <i className="fas fa-arrow-left sm:mr-2"></i>
                  <span className="hidden sm:inline">New Version</span>
                </Button>
              </Link>
              <Link href="/old/leaderboard">
