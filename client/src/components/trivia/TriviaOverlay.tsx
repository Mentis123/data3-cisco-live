          ...
          <div className="w-full max-w-[720px]" style={reservedStyle}>
            <div style={scaledWrapperStyle}>
              <div ref={contentRef} className="w-full max-w-[720px]">
                <TriviaGame
                  className="w-full rounded-3xl border-white/15 bg-slate-900/70 shadow-[0_45px_140px_-80px_rgba(56,189,248,0.75)] backdrop-blur-xl supports-[height:100dvh]:max-h-[calc(100dvh-2.5rem)] max-h-[calc(100svh-2.5rem)] sm:border-white/10"
                  questions={questions}
                  track={track}
                  mode={mode}
                  onComplete={(score) => {
