# CAUDIT 2026 — final cinematic edit

Runtime: **03:05**. Delivery: 1280 × 720, 16:9, 24 fps, H.264 video and stereo AAC audio, with optional SRT/WebVTT captions.
...
Attachment-order identifiers, distinct from the original prompt numbering:

| Clip | Content | Decision |
| --- | --- | --- |
| B01 | Campus adviser and technology lead | Used; short closing callback |
| B02 | University group discussion | Used; short relationship callback |
| B03 | Data centre corridor | Used for Azure |
| B04 | Operations team | Used for engagement / managed services |
| B05 | Architectural model | Reserve |
| B06 | Headset engineer | Used for incident ownership |
| B07 | Shared laptop review | Used for guidance; short agreement-cycle callback |
| B08 | Printed design materials | Reserve |

All eight browser copies are available in the Bible and B-roll page. Native B-roll audio is not used.

## Sound

The supplied continuous male ElevenLabs narration is unchanged. Forward Momentum and Horizon Open remain the two music sources. The revised music bed is substantially reduced, ducked during speech, and smoothly dipped at selected narrative moments. Horizon enters at 00:30.88; Forward fades out from 00:38 to 00:46.70. The ending has a short breath after the last spoken words.
